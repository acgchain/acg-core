...
Note that you can (and should) install the Windows version of postgres even when running acg-core from within WSL.
...
- Open the solution `Builds\VisualStudio\acg-core.sln`
