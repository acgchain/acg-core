...
getTestConfig(int instanceNumber, Config::TestDbMode mode)
{
    ...
    {
        gTestRoots.emplace_back("acg-core-test");
        ...
        sstream << "acg" << instanceNumber << ".log";
     ...
     std::vector<std::string> const& metrics)
{
    ...
    // not mixed with acg-core logging.
    Logging::setFmt("<test>");
    ...
    LOG(INFO) << "Testing acg-core " << STELLAR_CORE_VERSION;
    ...
    cli |= clara::Opt(gBaseInstance, "offset")["--base-instance"](
        ...
        "acg-core can run tests concurrently");
    session.cli(cli);
