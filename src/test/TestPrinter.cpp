...
{
std::string
StringMaker<acg::OfferState>::convert(acg::OfferState const& os)
{
    return fmt::format(
        ...
        os.type == acg::OfferType::PASSIVE ? "passive" : "active");
}

std::string
StringMaker<acg::CatchupRange>::convert(acg::CatchupRange const& cr)
{
...
std::string
StringMaker<acg::historytestutils::CatchupPerformedWork>::convert(
    acg::historytestutils::CatchupPerformedWork const& cm)
{
    return fmt::format("{}, {}, {}, {}, {}, {}, {}, {}",
