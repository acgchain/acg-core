...
The `acg-core` program has a single subclass of SCPDriver called
...
For details of the protocol itself, see the [paper on SCP](https://www.acg.org/papers/acg-consensus-protocol.pdf).
