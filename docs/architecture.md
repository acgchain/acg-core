...
Two slightly-obscurely-named components are:
  ...
  - SCP -- "Stellar Consensus Protocol", the component implementing the
    [consensus algorithm](https://www.acg.org/papers/acg-consensus-protocol.pdf).
...
- Set of core validator nodes. Running acg-core only. Tasked with:
...
- Set of public HTTP nodes. Not running acg-core. Running
...
- (optional): Set of public validator nodes. Running acg-core only. Tasked
with:
  ...
  - Basically just a acg-network load balancer / firewall for public access,
