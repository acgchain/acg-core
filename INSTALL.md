...
==================
These are instructions for building acg-core from source.

For a potentially quicker set up, the following projects could be good alternatives:

* acg-core in a [docker container](https://github.com/acg/docker-acg-core-horizon)
* pre-compiled [packages](https://github.com/acg/packages)

## Picking a version to run

Best is to use the latest *stable* release that can be downloaded from https://github.com/acg/acg-core/releases
...
#### Ubuntu 14.04
You will have to install the [test toolchain](#adding-the-test-toolchain) in order to both build and run acg-core.

#### Ubuntu 16.04
Just like 14.04, you can install the test toolchain to build and run acg-core.
...
- `git clone https://github.com/acg/acg-core.git`
- `cd acg-core`
- `git submodule init`
